 ...
 try {
     function validateForm() {
         ...
         if (comments == "" || comments == null) {
             document.getElementById('error-msg').innerHTML = "<div class='alert alert-warning error_message'>*Por favor ingrese un comentario*</div>";
             fadeIn();
             return false;
         }
         ...
         xhttp.open("POST", "public/assets/php/contact.php", true);
